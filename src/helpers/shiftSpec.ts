const _default = (function () {
  ...
  ArrayBinding.fields = [
    { name: "type", type: Const(TYPE_INDICATOR), value: "ArrayBinding" },
    {
      ...
      type: List(
        Maybe(
          Union(BindingWithDefault, Union(BindingIdentifier, Union(ArrayBinding, ObjectBinding))),
        ),
      ),
    },
    {
  ...
  EmptyStatement.fields = [{ name: "type", type: Const(TYPE_INDICATOR), value: "EmptyStatement" }];
  ...
  ThisExpression.fields = [{ name: "type", type: Const(TYPE_INDICATOR), value: "ThisExpression" }];
